...
This project is a Full-Stack Discord-like real time chat application that I am
developing as a learning excercise to improve my software design techniques
and practice with modern web development technologies. It is currently a
work in progress.

## Learning Goals

- Master real-time communication between frontend and backend programs using
  websockets.
...
Once the app is running head to the registration page and create an account to
use the app.
