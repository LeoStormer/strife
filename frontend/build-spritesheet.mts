...
const inputDir = path.join(cwd, "src", "assets", "svg");
...
async function generateIconFiles() {
    ...
    const typeOutputContent = "// This file is generated by npm run generate-svg-sprite\n\n"
    ...
    const readmeText = "# Icons\n\n"
        + "This directory contains SVG icons that are used by the app.\n\n"
        + "Every svg in this directory is collected into a spritesheet by a script. "
        + `The spritesheet will appear in the directory ${outputDirRelative} `
        + "as sprite.svg"
